            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full rounded-xl border border-stone-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-amber-400"
                ...
                <button
                    ...
                    className="w-full flex justify-center items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white font-semibold py-4 rounded-xl transition disabled:opacity-60"
